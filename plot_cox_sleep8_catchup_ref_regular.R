...
results <- fread(file='~/Documents/MGH Research/catchup_sleep/raw_outputs/cox_sleep8_ref_regular_sleep_adjust.csv')
...
# Plot p-values
pdf(file='~/Documents/MGH Research/catchup_sleep/plots/sleep8_catchup_ref_regular.pdf',height=5,width=12,pointsize=5)
...
write.csv(results,'~/Documents/MGH Research/catchup_sleep/processed/sleep8_catchup_ref_regular.csv',row.names=F)
