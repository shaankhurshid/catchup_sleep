...
# Plot p-values
pdf(file='~/Documents/MGH Research/catchup_sleep/plots/sleep7_regular_ref_inadequate.pdf',height=5,width=12,pointsize=5)
...
write.csv(results,'~/Documents/MGH Research/catchup_sleep/processed/sleep7_regular_ref_inadequate.csv',row.names=F)
