# # Script to create incidence waterfalls using pre-procesregular data
...
results <- fread(file='~/Documents/MGH Research/catchup_sleep/raw_outputs/cox_sleep8_ref_inadequate.csv')
...
results$upper_regular <- as.numeric(results$upper_regular)
...
# Plot p-values
pdf(file='~/Documents/MGH Research/catchup_sleep/plots/sleep8_regular_ref_inadequate.pdf',height=5,width=12,pointsize=5)
...
write.csv(results,'~/Documents/MGH Research/catchup_sleep/processed/sleep8_regular_ref_inadequate.csv',row.names=F)
